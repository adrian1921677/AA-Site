        ...
        <Dialog.Content asChild forceMount>
          ...
          >
            <div className="space-y-6">
              {/* Header */}
              <div>
                <Dialog.Title className="heading-2 text-text-primary mb-3">
                  {project.title}
                </Dialog.Title>
              ...
              <motion.div
                ...
                className="rounded-xl overflow-hidden bg-background-tertiary aspect-video flex items-center justify-center"
              >
                <div className="text-6xl text-text-tertiary">
                  {"</>"}
                </div>
              </motion.div>
              ...
              <Dialog.Close asChild>
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="absolute top-6 right-6 text-text-tertiary hover:text-text-primary transition-colors p-2 rounded-lg hover:bg-background-tertiary/50"
